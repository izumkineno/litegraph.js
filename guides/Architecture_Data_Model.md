...
- [LGraphNode.state.ts](../src/ts-migration/models/LGraphNode.state.ts)
- [LGraphNode.execution.ts](../src/ts-migration/models/LGraphNode.execution.ts)
- [LGraphNode.ports-widgets.ts](../src/ts-migration/models/LGraphNode.ports-widgets.ts)
- [LGraphNode.connect-geometry.ts](../src/ts-migration/models/LGraphNode.connect-geometry.ts)
- [LGraphNode.canvas-collab.ts](../src/ts-migration/models/LGraphNode.canvas-collab.ts)
- [LLink.ts](../src/ts-migration/models/LLink.ts)
- [LGraphGroup.ts](../src/ts-migration/models/LGraphGroup.ts)
- [serialization.ts](../src/ts-migration/types/serialization.ts)
