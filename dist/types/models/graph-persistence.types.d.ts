...
export interface LiteGraphPersistenceHost extends LiteGraphLifecycleHost, Pick<LiteGraphConstantsShape, "VERSION"> {
    createNode?: (type: string | null | undefined, title?: string) => GraphNodePersistenceLike | null;
...
type GraphNodePersistenceBase = Pick<LGraphNode, "id" | "serialize" | "configure" | "disconnectInput">;
...
export type GraphLinkPersistenceInput = GraphLinkPersistenceLike | readonly unknown[] | Record<string, unknown>;
export interface GraphDataForSerialize extends SerializedLGraph<unknown, unknown, unknown> {
    extra: Record<string, unknown>;
}
...
export interface GraphDeserializeTarget {
    ...
    extra: Record<string, unknown>;
    _version: number;
    add: (item: GraphNodePersistenceLike | GraphGroupPersistenceLike, skip_compute_order?: boolean) => unknown;
    getNodeById: (id: number | string | null | undefined) => GraphNodePersistenceLike | null | undefined;
