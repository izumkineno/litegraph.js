...
export interface ModernWidgetRenderContext<
...
export interface ModernWidgetActionContext<
    TNode extends { id: number | string } = { id: number | string },
    THost = unknown,
> extends ModernWidgetRenderContext<TNode, THost> {
    readonly handle: ModernWidgetViewHandle;
    readonly action: string;
    readonly event: PointerEvent;
}

export interface ModernWidgetRenderer<
    TNode extends { id: number | string } = { id: number | string },
    THost = unknown,
> {
    createView(
        context: ModernWidgetRenderContext<TNode, THost>
    ...
    ): ModernWidgetHit | null;
    performAction?(
        context: ModernWidgetActionContext<TNode, THost>,
        handle: ModernWidgetViewHandle
    ): ModernWidgetActionResult | void;
}
