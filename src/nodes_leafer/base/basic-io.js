(function(global) {
    ...
    ns.registerBaseModule("base/basic-io", function() {
        class DownloadData extends ns.BaseNode {
            constructor(title) {
                super(title);
                this.size = [60, 30];
            ...
            downloadAsFile() {
                ...
                var str = this.value.constructor === String
                    ? this.value
        ...
        class Watch extends ns.BaseNode {
            constructor(title) {
                super(title);
                this.size = [60, 30];
        ...
        class Cast extends ns.BaseNode {
            constructor(title) {
                super(title);
                this.addInput("in", 0);
        ...
        class ConsoleNode extends ns.BaseNode {
            constructor(title) {
                super(title);
        ...
        class AlertNode extends ns.BaseNode {
            constructor(title) {
                super(title);
                this.mode = LiteGraph.ON_EVENT;
                this.addProperty("msg", "");
